...
?>
    ...
    <div class="info-fon">
        <div class="info-text container">
            <p>Вывески являются важным элементом любого бизнеса, ведь они привлекают внимание к вашему местоположению, поддерживают бренд и улучшают восприятие компании. Именно поэтому изготовление вывесок – важный процесс, который требует высокого уровня профессионализма и ответственности.</p>
        </div>
    </div>
<?php
$this->registerJsFile(
